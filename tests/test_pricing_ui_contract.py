...
class PricingUiContractTests(unittest.TestCase):
    ...
    def test_ratecard_is_machine_readable_and_preview_only(self):
    ...
    def test_browser_quote_is_explicitly_non_authoritative_and_payment_stays_fail_closed(self):
        for token in (
        ...
        self.assertFalse(self.readiness["autonomous_purchase_declared"])
